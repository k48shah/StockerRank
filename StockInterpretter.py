...
#     raw_ticker = xlrd.open_workbook("StockScreenerTest.xlsx")
...
#                         assetList[index].append(finData.get("NetIncome")[-3]/finData.get("TotalAssets")[-3])
#                         infoBool += 1
...
#                         assetList[index].append(1/finData.get("EnterprisesValueEBITDARatio")[-3])
#                         infoBool += 1
...
#                     print("length vs stock: ", len(assetList[index]), stockList.index(stock)+1)
#
#                     print(assetList)
#                 if (len(assetList[index]) > stockList.index(stock) + 1):
#                     for x in range(stockList.index(stock), assetList[index]):
#                         assetList[index].remove(-1)
#                         print(assetList[index])
#                 print("lengths: ", len(assetList[0]), len(assetList[1]))
#                 try:
...
#             elif len(assetList[index]) < stockList.index(stock):
#                 print("Appending -10000000")
...
stockInfo = Ticker("rnwk")
finData = stockInfo.all_financial_data('q')

print(finData.get("asOfDate")[-3])
print(1/finData.get("EnterprisesValueEBITDARatio")[-3])
